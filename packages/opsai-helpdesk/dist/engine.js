export function diagnose(errorLog, context = {}) {
...
function detectStuckDeployments(deployments) {
    const now = Date.now();
...
export function recommendActions(context = {}) {
...
export function analyzeMetrics(metrics) {
    ...
    const anomalies = detectAnomalies({
        bookings: bookingBaseline != null && bookingCurrent != null
