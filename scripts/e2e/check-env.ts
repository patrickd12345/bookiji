...
const anonKey = parsed.NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY
...
requireVar('SUPABASE_SECRET_KEY', serviceRoleKey)
requireVar('NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY', anonKey)
