...
export function makeCreditsStatusHandler(getUserCreditsImpl = getUserCredits) {
  return async function GET(request: NextRequest) {
    ...
    const result = await getUserCreditsImpl(userId)
...
export const GET = makeCreditsStatusHandler()
