...
export default function ProviderMap() {
  ...
  useEffect(() => {
    if (typeof window === 'undefined' || !token || !mapRef.current || mapInstanceRef.current) return;
    ...
    map.on('load', () => {
      ...
      // Add privacy radius circles source
  ...
  // Update map data when providers change
  useEffect(() => {
