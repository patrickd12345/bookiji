-- Reschedule System Migration
-- This migration adds the complete reschedule system including:
-- 1. Reschedule tokens table for secure reschedule operations
-- 2. Additional booking fields for reschedule tracking
-- 3. RPC function for atomic reschedule completion

-- ========================================
-- 1. RESCHEDULE TOKENS TABLE
-- ========================================

CREATE TABLE IF NOT EXISTS public.reschedule_tokens (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  jti TEXT NOT NULL UNIQUE, -- JWT ID for single-use validation
...
-- ========================================
-- 3. RPC FUNCTION FOR RESCHEDULE COMPLETION
-- ========================================
...
GRANT EXECUTE ON FUNCTION public.reschedule_complete_tx TO authenticated;

-- ========================================
-- 4. CLEANUP FUNCTION FOR EXPIRED HOLDS
-- ========================================
...
COMMENT ON FUNCTION public.reschedule_complete_tx IS 'Atomic transaction to complete a reschedule operation';
