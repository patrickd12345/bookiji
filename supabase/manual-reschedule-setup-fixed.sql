-- Manual Reschedule System Setup - FIXED VERSION
-- Copy and paste this into your Supabase SQL Editor
-- This script handles existing tables and adds missing columns safely

-- ========================================
-- 1. RESCHEDULE TOKENS TABLE (CREATE OR MODIFY)
-- ========================================
